---
description: Sync ./docs/library/ when schemas/models change or features are added/removed.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

There is a wiki under `./docs/library/` that tracks usage docs for consuming LANScape as a library or as a WebSocket server. If the current changes affect schemas/models or add/remove features, the wiki **must** be updated.

Before making changes:

1. Read enough of `./docs/library/` to understand how the wiki is structured and formatted.
